...
public class StreamNetworkThroughputBenchmarkExecutor extends BenchmarkBase {
	...
	public static class MultiEnvironment extends StreamNetworkThroughputBenchmark {
		...
		@Param({"1000,1ms", "1000,100ms", "1000,100ms,SSL"})
		...
		public void setUp() throws Exception {
			...
			//configuration.setInteger(NettyShuffleEnvironmentOptions.NETWORK_BUFFERS_PER_SUBPARTITION, 2);
			configuration.setInteger(NettyShuffleEnvironmentOptions.NETWORK_BUFFERS_PER_CHANNEL, 2);
			//configuration.setInteger(NettyShuffleEnvironmentOptions.NETWORK_EXTRA_BUFFERS_PER_GATE, 64);
			...
			setUp(
					...
					useSSL ? SSLUtilsTest.createInternalSslConfigWithKeyAndTrustStores(
							SecurityOptions.SSL_PROVIDER.defaultValue()) : configuration
			);
		}
