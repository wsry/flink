...
public class SuccessAfterNetworkBuffersFailureITCase extends TestLogger {
	...
	private static Configuration getConfiguration() {
		...
		config.set(TaskManagerOptions.NETWORK_MEMORY_MIN, MemorySize.ofMebiBytes(20L));
		config.set(TaskManagerOptions.NETWORK_MEMORY_MAX, MemorySize.ofMebiBytes(20L));
		return config;
	}
