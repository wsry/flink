...
public class DynamicFilteringRule1 extends DynamicFilteringRuleBase {

    public static final RelOptRule FACT_IN_RIGHT =
            DynamicFilteringRule1.Config.EMPTY
                    .withDescription("DynamicFilteringRule1:factInRight")
                    .as(Config.class)
                    .factInRight()
                    .toRule();

    public DynamicFilteringRule1(RelRule.Config config) {
        super(config);
    }
    ...
    public interface Config extends RelRule.Config {
        @Override
        default DynamicFilteringRule1 toRule() {
            return new DynamicFilteringRule1(this);
        }
