...
public class DynamicFilteringRule6 extends DynamicFilteringRuleBase {

    public static final RelOptRule FACT_IN_LEFT =
            DynamicFilteringRule6.Config.EMPTY
                    .withDescription("DynamicFilteringRule6:factInLeft")
                    .as(Config.class)
                    .factInLeft()
                    .toRule();

    public DynamicFilteringRule6(RelRule.Config config) {
        super(config);
    }
    ...
    public interface Config extends RelRule.Config {
        @Override
        default DynamicFilteringRule6 toRule() {
            return new DynamicFilteringRule6(this);
        }
