...
public class DynamicFilteringRule3 extends DynamicFilteringRuleBase {

    public static final RelOptRule FACT_IN_RIGHT =
            DynamicFilteringRule3.Config.EMPTY
                    .withDescription("DynamicFilteringRule3:factInRight")
                    .as(Config.class)
                    .factInLeft()
                    .toRule();

    public DynamicFilteringRule3(RelRule.Config config) {
        super(config);
    }
    ...
    public interface Config extends RelRule.Config {
        @Override
        default DynamicFilteringRule3 toRule() {
            return new DynamicFilteringRule3(this);
        }
