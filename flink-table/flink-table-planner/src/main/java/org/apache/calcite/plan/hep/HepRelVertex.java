...
/**
 * HepRelVertex wraps a real {@link RelNode} as a vertex in a DAG representing the entire query
 * expression.
 */
public class HepRelVertex extends AbstractRelNode {
     ...
     */
    public void replaceRel(RelNode newRel) {
        currentRel = newRel;
    }
    ...
    public boolean deepEquals(Object obj) {
        return this == obj
                || (obj instanceof HepRelVertex && currentRel == ((HepRelVertex) obj).currentRel);
    }
