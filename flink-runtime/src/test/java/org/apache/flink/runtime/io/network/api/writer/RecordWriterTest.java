...
public class RecordWriterTest {
	...
	public void testBroadcastEventNoRecords() throws Exception {
		...
		BufferPool bufferProvider = createBufferProvider(numBuffers, bufferSize, queues.length);
	...
	public void testBroadcastEventMixedRecords() throws Exception {
		...
		BufferPool bufferProvider = createBufferProvider(numBuffers, bufferSize, numberOfChannels);
	...
	public void testBroadcastEmitRecord() throws Exception {
		...
		final BufferPool bufferProvider = createBufferProvider(numBuffers, bufferSize, numberOfChannels);
	...
	protected BufferPool createBufferProvider(int numBuffers, int bufferSize, int numberOfChannels) throws IOException {
		NetworkBufferPool networkBufferPool = new NetworkBufferPool(numBuffers, bufferSize);
		return networkBufferPool.createBufferPool(numBuffers, numBuffers, null, numberOfChannels, Integer.MAX_VALUE);
	}
