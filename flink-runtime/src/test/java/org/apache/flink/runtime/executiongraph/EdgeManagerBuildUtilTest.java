...
public class EdgeManagerBuildUtilTest {
    ...
    private void testGetMaxNumEdgesToTarget(
        ...
        for (ExecutionVertex ev : upstreamEJV.getTaskVertices()) {
            Assertions.assertThat(ev.getProducedPartitions().size()).isEqualTo(1);
        ...
        Assertions.assertThat(actualMaxForUpstream).isEqualTo(calculatedMaxForUpstream);
        ...
        for (ExecutionVertex ev : downstreamEJV.getTaskVertices()) {
            Assertions.assertThat(ev.getNumberOfInputs()).isEqualTo(1);
        ...
        Assertions.assertThat(actualMaxForDownstream).isEqualTo(calculatedMaxForDownstream);
    }
