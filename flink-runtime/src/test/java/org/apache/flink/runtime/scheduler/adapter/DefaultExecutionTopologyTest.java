...
public class DefaultExecutionTopologyTest extends TestLogger {
    ...
    void testUpdateTopology() throws Exception {
        ...
        Assertions.assertThat(IterableUtils.toStream(adapter.getVertices()).count()).isEqualTo(6L);
    ...
    void testExistingRegionsAreNotAffectedDuringTopologyUpdate() throws Exception {
        ...
        Assertions.assertThat(regionNew).isSameAs(regionOld);
    }
    ...
    private void assertRegionContainsAllVertices(
        ...
        Assertions.assertThat(allVertices).isEqualTo(Sets.newHashSet(adapter.getVertices()));
    }
    ...
    private static void assertGraphEquals(
        ...
        while (originalVertices.hasNext()) {
            ...
            Assertions.assertThat(adaptedVertex.getId()).isEqualTo(originalVertex.getID());
        ...
        Assertions.assertThat(adaptedVertices.hasNext()).isFalse();
    }
    ...
    private static void assertPartitionsEquals(
        ...
        Assertions.assertThat(Iterables.size(adaptedResultPartitions))
        ...
        for (IntermediateResultPartition originalPartition : originalResultPartitions) {
            ...
            Assertions.assertThat(adaptedConsumers.isEmpty()).isFalse();
    ...
    private static void assertPartitionEquals(
        ...
        Assertions.assertThat(adaptedPartition.getId())
                .isEqualTo(originalPartition.getPartitionId());
        Assertions.assertThat(adaptedPartition.getResultId())
                .isEqualTo(originalPartition.getIntermediateResult().getId());
        Assertions.assertThat(adaptedPartition.getResultType())
                .isEqualTo(originalPartition.getResultType());
        Assertions.assertThat(adaptedPartition.getProducer().getId())
