...
public class AdaptiveBatchSchedulerTest extends TestLogger {
    ...
    void testAdaptiveBatchScheduler() throws Exception {
        ...
        Assertions.assertThat(sinkExecutionJobVertex.getParallelism()).isEqualTo(-1);
        ...
        Assertions.assertThat(sinkExecutionJobVertex.getParallelism()).isEqualTo(10);

        // check that the jobGraph is updated
        Assertions.assertThat(sink.getParallelism()).isEqualTo(10);
    }
    ...
    void testDecideParallelismForForwardTarget() throws Exception {
        ...
        // trigger source2 finished.
        transitionExecutionsState(scheduler, ExecutionState.FINISHED, source2);
        Assertions.assertThat(sinkExecutionJobVertex.getParallelism())
                .isEqualTo(SOURCE_PARALLELISM_1);

        // check that the jobGraph is updated
        Assertions.assertThat(sink.getParallelism()).isEqualTo(SOURCE_PARALLELISM_1);
    }
