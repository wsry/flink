...
public class SortMergeSubpartitionReader implements ResultSubpartitionView, BufferRecycler {
	...
	public SortMergeSubpartitionReader(
		...
		fileReader = new PartitionedFileReader(partitionedFile, subpartitionIndex);
		try {
			fileReader.open();
			readBuffers();
	...
	public BufferAndBacklog getNextBuffer() {
		...
		return BufferAndBacklog.fromBufferAndLookahead(buffer, buffersRead.peek(), dataBufferBacklog, sequenceNumber++);
	}
