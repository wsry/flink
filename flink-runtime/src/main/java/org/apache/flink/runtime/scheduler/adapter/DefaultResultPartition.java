...
class DefaultResultPartition implements SchedulingResultPartition {
    ...
    private final Supplier<List<ConsumerVertexGroup>> consumerVertexGroupSupplier;
    ...
    DefaultResultPartition(
            ...
            Supplier<List<ConsumerVertexGroup>> consumerVertexGroupSupplier,
    ...
    public List<ConsumerVertexGroup> getConsumerVertexGroups() {
        return checkNotNull(consumerVertexGroupSupplier.get());
    }
