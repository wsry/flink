 ...
 * serializing records into bytes.
 *
...
public abstract class RecordWriter<T extends IOReadableWritable> implements AvailabilityProvider {
	...
	protected void emit(T record, int targetSubpartition) throws IOException {
		...
		targetPartition.emitRecord(serializeRecord(record), targetSubpartition);
	...
	protected ByteBuffer serializeRecord(T record) throws IOException {
		serializer.clear();
