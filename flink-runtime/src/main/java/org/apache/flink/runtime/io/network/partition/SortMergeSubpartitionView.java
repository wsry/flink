...
class SortMergeSubpartitionView
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SortMergeSubpartitionView.class);
    ...
    public int compareTo(SortMergeSubpartitionView that) {
        long thisPriority = readingProgress.getFileOffset();
        long thatPriority = that.readingProgress.getFileOffset();
