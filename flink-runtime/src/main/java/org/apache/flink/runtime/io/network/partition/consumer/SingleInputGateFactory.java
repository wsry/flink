...
public class SingleInputGateFactory {
    ...
    private int determineBuffersPerChannel(ResultPartitionType partitionType) {
        return partitionType.isBlocking() ? 0 : configuredNetworkBuffersPerChannel;
    }
